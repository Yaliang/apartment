;(function () {
	...
	userJS.prototype.getName = function(o) {
		o = o || {}
	...
	userJS.prototype.selectApt = function(o) {
		o = o || {}
		if (!window.userJS.checkLogin) {
			if (o.error) {
				o.error(window.errorCode.noLogin)
		...
		var query = new Parse.Query(apartment)
		query.equalTo('member',crtUser.id)
	...
	userJS.prototype.enterApt = function(o) {
		o = o || {}
		if (!window.userJS.checkLogin) {
			if (o.error) {
				o.error(window.errorCode.noLogin)
